...
@router.post("/project/{project_no}/delete_report_file/{report_no}/{file_id}")
async def delete_report_file(
    ...
    return await report_service.delete_report_file(project_no, report_no, file_id, user, db)